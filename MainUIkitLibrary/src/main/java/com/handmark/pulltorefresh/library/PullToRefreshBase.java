...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final void onRefreshComplete() {
        if (mState == State.REFRESH_ONLY_SHOWLOADING) {
            mState = State.RESET;
            mHeaderLayout.reset();
    ...
    //only show header loading view,will not call ui refresh action
    public final void onShowHeaderLoadingAction() {
//        if (mState == State.REFRESH_ONLY_SHOWLOADING) {
//            return;
//        }
//        mState = State.REFRESH_ONLY_SHOWLOADING;
...
//        }
    ...
    protected void onReset() {
        ...
        //hide first,adn delay reset by liu
